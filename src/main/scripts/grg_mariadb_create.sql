create table base_ingredient (id bigint not null auto_increment, description varchar(255), primary key (id)) engine=InnoDB;
create table category (id bigint not null auto_increment, description varchar(255), primary key (id)) engine=InnoDB;
create table ingredient (id bigint not null auto_increment, amount decimal(19,2), base_ingredient_id bigint, recipe_id bigint, uom_id bigint, primary key (id)) engine=InnoDB;
...
alter table ingredient add constraint FKhe4603p2jtb5x56jvk8k4i2yg foreign key (base_ingredient_id) references base_ingredient (id);
